...
export function HeroSection() {
  ...
  return (
    <div className="w-full bg-orange-overlay min-h-screen relative">
      ...
      <div className="w-full min-h-auto max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-start gap-8 px-4 py-8 lg:px-20 lg:py-10 relative">
        ...
        <div className="w-full flex justify-start items-start flex-col gap-4">
          ...
          <p
            className={`text-lg transition-colors duration-700 ${
              true ? "text-white/50" : "text-orange-400"
            }`}
          >
            Somos parceiros no <strong>crescimento da sua marca</strong>.
            Ajudamos você a alcançar novos resultados com{" "}
          ...
          <p
            className={`transition-colors duration-700 ${
              true ? "text-white" : "text-orange-400"
            }`}
          >
          ...
          <div className="grid grid-cols-3 justify-items-center sm:justify-items-start w-full">
            <div className="flex justify-start items-start gap-1 flex-col">
              <span className="text-orange-reflex text-5xl font-extrabold">
                7+
              </span>
              <span className="text-white/70 text-sm">Anos de Experiência</span>
            </div>
            <div className="flex justify-start items-start gap-1 flex-col">
              <span className="text-orange-reflex text-5xl font-extrabold">
                100+
              </span>
              <span className="text-white/70 text-sm">Projetos Entregues</span>
            </div>
            <div className="flex justify-start items-start gap-1 flex-col">
              <span className="text-orange-reflex text-5xl font-extrabold">
                50+
        ...
        <div className="w-full flex justify-start items-end flex-col relative">
          ...
          <div className="animate-icon-move-2 w-24 h-24 absolute top-0 sm:top-12 left-36 flex justify-center items-center bg-gray-200/10 backdrop-blur-md rounded-md border-4 border-gray-600/40">
            <Image
